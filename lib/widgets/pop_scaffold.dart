...
class PopScaffold<T> extends StatelessWidget {
  const PopScaffold({
    super.key,
    this.appBar,
    this.body,
  ...
  /// Pass this value to override default [PopScope.canPop] value.
  /// By default it is given [context.canPop] which checks if there is any route in stack to pop.
  final bool? canPopOverride;

  /// Override for [PopScope.onPopInvokedWithResult] by default it checks if popped. else it navigates to home.
  final PopInvokedWithResultCallback<T>? onPopInvokedWithResult;

  @override
  Widget build(BuildContext context) {
    return PopScope(
      canPop: canPopOverride ?? context.canPop(),
